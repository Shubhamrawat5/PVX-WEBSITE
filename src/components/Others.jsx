...
import medal1Img from "../asserts/images/medal 1.png";
        ...
        <div className="achieve-box tournament">
          <div className="winners">
            <div className="winners-2">
              <img src={medal2Img} alt="2" className="medal-img" />
              <p>Nikunj NJV</p>
            </div>
            <div className="winners-1">
              <img src={medal1Img} alt="1" className="medal-img" />
              <p>Ash</p>
            </div>
            <div className="winners-3">
              <img src={medal3Img} alt="3" className="medal-img" />
              <p>Sweeton</p>
            </div>
          </div>
